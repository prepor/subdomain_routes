...
(Note that the SubdomainRoutes gem requires Rails 2.2 or later to run since it changes <code:ruby>ActionController::Resources::INHERITABLE_OPTIONS</code>. If you're on an older version of Rails, you need to get with the program. ;)
